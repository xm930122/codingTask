...
export default function Home() {
  const { tokens, isConnected, reconnect } = useWebSocket();
    ...
    <div className="min-h-screen bg-background  py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          {!isConnected && (
            <button onClick={reconnect} className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
              Reconnect
            </button>
          )}
        </div>
